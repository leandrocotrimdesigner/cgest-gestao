        ...
        <div className="lg:col-span-1">
          <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-100 sticky top-4">
            ...
            <form onSubmit={handleAddTask} className="space-y-4">
              ...
              <button type="submit" className="w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow-md">Adicionar</button>
            </form>
          </div>
        </div>
