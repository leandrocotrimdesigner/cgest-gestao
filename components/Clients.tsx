...
const Clients: React.FC<ClientsProps> = ({ 
  ...
  const handleWhatsAppChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      // Remove tudo que não for número (visual feedback for user)
        ...
        <form onSubmit={handleClientSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4">
                ...
                <button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-bold flex items-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
